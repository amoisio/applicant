 ...
 * @returns {TemplateQuestion} A new template question.
 */
 ...
 * @param {TemplateQuestion} question Question to change.
 * @returns {TemplateQuestion} A new template question with the changed text.
 */
